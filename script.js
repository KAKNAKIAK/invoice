    ...
    <div class="max-w-full mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-xl">
        <header class="mb-8 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                <button type="button" id="saveBtn" class="btn btn-sm btn-secondary"><i class="fas fa-save"></i> 저장(Shift + S)</button>
                <button type="button" id="saveAsBtn" class="btn btn-sm btn-secondary"><i class="fas fa-file-export"></i> 다른 이름으로 저장(Shift + W)</button>
                <label for="loadFile" class="btn btn-sm btn-secondary cursor-pointer"><i class="fas fa-folder-open"></i> 불러오기(Shift + F)</label>
                <button type="button" id="recentFilesBtn" class="btn btn-sm btn-secondary"><i class="fas fa-history"></i> 최근 파일(Shift + R)</button>
            </div>
        </header>
            ...
            <div class="flex gap-6 mb-8">
                ...
                <div class="w-1/2 flex gap-6">
                    <section class="w-1/2 p-6 border border-gray-200 rounded-lg flex flex-col">
                        ...
                        <textarea id="memoText" class="input-field flex-grow" placeholder="여기에 메모를 입력하세요..."></textarea>
                    </section>
                    <section class="w-1/2 p-6 border border-gray-200 rounded-lg">
                        <h2 class="text-xl font-semibold text-gray-800 mb-4">업무 보조 툴</h2>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-4">
                            <a href="https://kaknakiak.github.io/ERPTOGDS/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">GDS 엔트리 생성기</a>
                            <a href="https://kaknakiak.github.io/PNRTOERP/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">PNR 네임필드추출</a>
                            <a href="https://incomparable-meringue-d33b6b.netlify.app/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">간편 URL 단축기</a>
                            <a href="https://kaknakiak.github.io/hotelbooking/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">호텔 수배서 작성기</a>
                            <a href="https://kaknakiak.github.io/hotelinformation/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">호텔카드 메이커</a>
                            <a href="https://kaknakiak.github.io/tripplantest2/" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline text-xs text-center">상세일정표</a>
                        </div>
                    </section>
                </div>
            </div>
