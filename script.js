...
function restoreCalculatorState(instanceContainer, calcData) {
    ...
    if (pnrTitleSpan) {
        ...
        pnrTitleSpan.addEventListener('click', (e) => {
            e.stopPropagation();
